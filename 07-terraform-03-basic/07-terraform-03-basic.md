...
Terraform will perform the following actions:
  ...
  # yandex_compute_instance.node1[0] will be created
  + resource "yandex_compute_instance" "node1" {
      + allow_stopping_for_update = true
      + created_at                = (known after apply)
      + folder_id                 = (known after apply)
      + fqdn                      = (known after apply)
      + hostname                  = "node10.netology.cloud"
  ...
  # yandex_compute_instance.node1[1] will be created
  + resource "yandex_compute_instance" "node1" {
      + allow_stopping_for_update = true
      + created_at                = (known after apply)
      + folder_id                 = (known after apply)
      + fqdn                      = (known after apply)
      + hostname                  = "node11.netology.cloud"
      + id                        = (known after apply)
      + metadata                  = {
          + "user-data" = <<-EOT
                #cloud-config
  ...
  # yandex_compute_instance.node2["app"] will be created
  ...
  # yandex_compute_instance.node2["db"] will be created
  + resource "yandex_compute_instance" "node2" {
      + created_at                = (known after apply)
      + folder_id                 = (known after apply)
      + fqdn                      = (known after apply)
